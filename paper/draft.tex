...
different models.
%
All differences in model are significant using an
Independent\footnote{An Independent t-test was used instead of a
  Paired-Sample t-test because of intermittent failures during
  linearization that resulted in slightly different numbers of
  observations.} t-test ($p<10^{-5}$).
%
...
In our experiments, the corpus was preprocessed using the Stanford
Parser to fix common issues and remove extraneous information.  The
