...
\emph{structurally}, by using a convolutional coding over the
...
sentences with an average length of XXX.
%
...
models from the standpoint of parsing and understanding, including
networks that maintain state using recurrences and networks that
agglomerate information using tree traversals.
%
...
parse trees \cite{Andreas2016LearningTC}.
