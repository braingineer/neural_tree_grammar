...
%
The evaluation uses the Wall Street Journal sections of the Penn Treebank which have been previously used for statistical tree grammars \cite{chiang2000statistical}\footnote{A possible additional data source, the data from the 2011 Shared Task on Surface Realization, was not available}.
%
...
%
Abstracting syntactic information from the derivation tree leads to the unlabeled dependency trees our models assume as input. 
...
\begin{figure}
\centering
\begin{tabular}{|l|p{2cm}|p{1.5cm}|}
\hline
Model & Test Set Size & Accuracy \\ \hline
